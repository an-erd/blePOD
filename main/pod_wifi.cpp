...
static const char* TAG = "POD_WIFI";
...
static esp_err_t event_handler(void *ctx, system_event_t *event)
{
    ...
    switch(event->event_id) {
        ...
        case SYSTEM_EVENT_STA_GOT_IP:
            ...
            ESP_ERROR_CHECK(esp_event_post_to(pod_loop_handle, WORKFLOW_EVENTS, POD_WIFI_GOT_IP_EVT, NULL, 0, portMAX_DELAY));
            break;
